...
int main()
{
	...
	cout << endl;
	reverse(numbers10, numbers10 + size10);
	...
	//Task 11
	const int size11_1 = 5, size11 = 10;
	int numbers11_1[size11_1], numbers11_2[size11_1], numbers11[size11];

	cout << "First array: ";
	for (int i = 0; i < size11_1; i++) {
		numbers11_1[i] = rand();
		cout << numbers11_1[i] << " ";
	}
	cout << endl;
	...
	for (int i = 0, j = 0; i < size11; i += 2, j++) {
		numbers11[i] = numbers11_1[j];
	}
	for (int i = 1, j = 0; i < size11; i += 2, j++) {
		numbers11[i] = numbers11_2[j];
	}
	cout << endl;
	cout << "Third array: ";
	...
	//Task 12
	const int size12 = 20;
	int numbers12[size12], numbers12_res[size12], n = 0;

	for (int i = 0; i < size12; i++) {
		numbers12[i] = rand() % 201 - 100;
		cout << numbers12[i] << " ";
	}
	cout << endl;
	for (int i = 0; i < size12; i++) {
		if (numbers12[i] > 0) {
			numbers12_res[n] = numbers12[i];
			n++;
		}
	}
	for (int i = 0; i < size12; i++) {
